...
public class BiorayInfusionMatrixGeoModel extends GeoModel<BiorayInfusionMatrixEntity> {
    ...
    private final Identifier model = Identifier.of(MODID, "block/infusion_matrix");
    private final Identifier animations = Identifier.of(MODID, "block/infusion_matrix");
    private final Identifier texture = Identifier.of(MODID, "textures/block/infusion_matrix.png");
