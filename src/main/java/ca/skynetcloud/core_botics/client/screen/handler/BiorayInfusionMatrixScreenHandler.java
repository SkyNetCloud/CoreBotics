...
public class BiorayInfusionMatrixScreenHandler extends ScreenHandler {
    ...
    public BiorayInfusionMatrixScreenHandler(int syncId, PlayerInventory playerInventory, PropertyDelegate propertyDelegate, ScreenHandlerContext context) {
    ...
    public BiorayInfusionMatrixScreenHandler(int syncId, PlayerInventory playerInventory) {
